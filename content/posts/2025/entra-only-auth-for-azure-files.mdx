---
description: >-
  Azure Files now supports Entra ID–only authentication for SMB, removing the
  need for domain controllers and enabling fully cloud-native AVD architectures.
...
category: VDI
heroImg: /uploads/Blogs/azure-files-entra-hero.png
excerpt: >
  ...
  Entra Kerberos authentication and configure folder permissions directly  in
  the Azure Portal for truly cloud-native AVD with FSLogix.
