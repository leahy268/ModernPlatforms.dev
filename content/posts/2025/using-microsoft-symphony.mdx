...
excerpt: |
  Testing IAC is always a problem. Waiting for a full deployment to occur before discovering bugs is a time-consuming process. Using Microsoft Symphony, we can validate Bicep code early and avoid unnecessary delays.
---
