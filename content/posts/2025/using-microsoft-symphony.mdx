...
**Getting Started Guide**: [https://github.com/microsoft/symphony/blob/main/docs/GETTING_STARTED.md](https://github.com/microsoft/symphony/blob/main/docs/GETTING_STARTED.md)
...
It’s worth exploring AVMs as part of your strategy — possibly the topic of a follow-up post.
