...
You can find further instructions here: [https://github.com/microsoft/symphony/blob/main/docs/GETTING\_STARTED.md](https://github.com/microsoft/symphony/blob/main/docs/GETTING_STARTED.md)

### 2. Define a Test Workflow

The repo that is created contains a number of workflows already.  
\`
...
To integrate this into a CI/CD pipeline, add Symphony to your pipeline configuration. Here’s an example using GitHub Actions:
