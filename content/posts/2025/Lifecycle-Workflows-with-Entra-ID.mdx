 ...
 *Note: Entra ID Governance is a paid add-on and is not included in Microsoft 365 E3/E5 by default. You can license users individually or via EMS E5 bundles.*

---

## Step-by-Step: How to Set Up a Lifecycle Workflow

### 1. **Enable Microsoft Entra ID Governance**

- Go to **Microsoft Entra Admin Center**
- Navigate to **Identity Governance → Lifecycle Workflows**
- If not enabled, activate your Entra ID Governance trial or subscription
...
- **Security-Driven**: Timely offboarding reduces access risk
...
However, if your organization uses Workday or SAP for HR, **API-driven provisioning** might be better aligned.
...
*Need help planning your joiner-mover-leaver strategy? Let’s talk about Entra ID Governance in your environment.*
